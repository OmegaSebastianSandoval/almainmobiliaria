...
define('PUBLIC_html_PATH', APP_PATH . "../public_html/");
...
$env = "development";
if (strpos($_SERVER['HTTP_HOST'], "juansalas.omegasolucionesweb.com") !== false) {
  $env = "staging";
} else if (strpos($_SERVER['HTTP_HOST'], "juansalasinmobiliaria.com") !== false) {
  $env = "production";
}

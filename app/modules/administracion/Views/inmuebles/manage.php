		...
		<div class="content-dashboard">
			...
			<div class="row">
				...
				<div class="col-3 form-group d-grid">
					<label class="control-label">Inmueble Importante (Si, NO)</label>
					<input type="checkbox" name="inmueble_importante" value="1" class="form-control switch-form " <?php if ($this->getObjectVariable($this->content, 'inmueble_importante') == 1) {
																											echo "checked";
																										} ?>></input>
					<div class="help-block with-errors"></div>
				</div>
			...
			<div class="row">
				...
				<div class="col-4 form-group">
					<label for="inmueble_deposito" class="control-label">Depósito</label>
					<label class="input-group">
						<div class="input-group-prepend">
							<span class="input-group-text input-icono"><i class="fa-solid fa-dollar-sign"></i></span>
						</div>
						<input type="text" value="<?= $this->content->inmueble_deposito; ?>" name="inmueble_deposito2" id="inmueble_deposito2" class="form-control" onkeyup="convertir('inmueble_deposito2','inmueble_deposito');" onchange="convertir('inmueble_deposito2','inmueble_deposito');">
						<input type="hidden" value="<?= $this->content->inmueble_deposito; ?>" name="inmueble_deposito" id="inmueble_deposito" class="form-control">
...
<script type="text/javascript">
	...
	function formatInitialValues() {
		...
		convertir('inmueble_deposito2', 'inmueble_deposito');

...
class Administracion_Model_DbTable_Inmuebles extends Db_Table
{
	...
	public function insert($data)
	{
		...
		$inmueble_deposito = $data['inmueble_deposito'];
		$inmueble_importante = $data['inmueble_importante'];

		$query = "INSERT INTO inmuebles( tipo, ref, area, NombreVendedor, departamento, ciudad, sector, localidad, descripcion, venta, alquiler, administracion, descripcionE, titulo, banos, Alcobas, parqueaderos, direccion, duena, telefonod, estrato, tiempoconstruido, ndepiso, tipoinstalacion, vigilancia, caracteristicasadicionales, ocultar, inmueble_deposito, inmueble_importante ) VALUES ( '$tipo', '$ref', '$area', '$NombreVendedor', '$departamento', '$ciudad', '$sector', '$localidad', '$descripcion', '$venta', '$alquiler', '$administracion', '$descripcionE', '$titulo', '$banos', '$Alcobas', '$parqueaderos', '$direccion', '$duena', '$telefonod', '$estrato', '$tiempoconstruido', '$ndepiso', '$tipoinstalacion', '$vigilancia', '$caracteristicasadicionales', '$ocultar', '$inmueble_deposito', '$inmueble_importante')";

...
class Administracion_contenidoController extends Administracion_mainController
{
  ...
  public function manageAction()
  {
    ...
    if ($contentpadre->contenido_tipo == 1) {
      ...
      $this->_view->tipo = 19;
    } else if ($contentpadre->contenido_tipo == 19) {
      $this->_view->tipo = 20;
  ...
  private function getData()
  {
    ...
    if ($this->_getSanitizedParam("contenido_titulo_principal") == '') {
      $data['contenido_titulo_principal'] = '0';
    } else {
      $data['contenido_titulo_principal'] = $this->_getSanitizedParam("contenido_titulo_principal");
    }
  ...
  private function getContenidoseccion()
  {
    $array = array();
    $array['1'] = 'Home';
    $array['2'] = 'Inventario de Inmuebles';
    $array['3'] = 'Conózcanos';
    $array['4'] = 'Servicios';
    $array['5'] = 'Procesos';
    $array['6'] = 'Archivos Descargables';

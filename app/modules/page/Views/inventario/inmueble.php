...
<div class="container contenedor-inmueble pt-3 pb-4">
    <div class="d-none justify-content-start mb-3" id="btn-inmueble">
        <a href="/page/inventario/filtrar/?<?= $this->queryString ?>" class="btn-home m-0">
    ...
    <div class="row">
        <div class="col-12 col-md-6">
            ...
            <div class="title-location">
                ...
                <h2> <?php if ($this->inmueble->direccion) { ?>
            ...
            <div class="contenedorfotos d-block d-md-none" id="contenedorfotosres">
                <div>
                    <div class="f-carousel" id="myCarouselRes">
                        <?php if (is_countable($this->fotos) && count($this->fotos) >= 1) { ?>

                            <?php foreach ($this->fotos as $foto) { ?>

                                <?php if ($foto->foto && file_exists($_SERVER['DOCUMENT_ROOT'] . "/images/" . $foto->foto)) { ?>
                        ...
                        <?php } else { ?>
                            <img src="/skins/page/images/Corte/imagenot.jpg" alt="Imagen de " class="img-inmueble">
            ...
            <div class="contenedor-descripcion">
                ...
                <div class="descripcion">
                    ...
                    <div class="row">
                                ...
                                <div class="d-flex gap-4 align-items-center cont-info">
                                    ...
                                    <div>
                                        ...
                                        <span class="d-block sub-detalle">
                                            ...
                                            $ <?php echo number_format($this->inmueble->administracion) ?>
                        ...
                        <?php if ($this->inmueble->inmueble_deposito) { ?>
                                ...
                                <div class="d-flex gap-4 align-items-center cont-info">
                                    ...
                                    <div>
                                        ...
                                        <span class="d-block sub-detalle">
                                            ...
                                            $ <?php echo number_format($this->inmueble->inmueble_deposito) ?>
        ...
        <div class="col-12 col-md-6">
            <div class="d-flex justify-content-end mb-3" id="btn-inmueble-volver">
                <a href="/page/inventario/filtrar/?<?= $this->queryString ?>" class="btn-home m-0">
                    <i class="fa-solid fa-circle-arrow-left"></i> Volver
                </a>
            </div>
            <div class="contenedorfotos d-none d-md-block" id="contenedorfotos">
                <div>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const contenedorfotosres = document.getElementById('contenedorfotosres');
        contenedorfotosres.classList.add('fadein');
    });
    ...
    new Carousel(
        document.getElementById("myCarouselRes"), {
            // Your custom options
            Dots: false,
        }, {
            Thumbs,

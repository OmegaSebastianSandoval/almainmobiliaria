...
class Page_inventarioController extends Page_mainController
{
	...
	public function inmuebleAction()
	{
		...
		// Capturar todos los parámetros GET para el botón de volver
		// $queryString = http_build_query($_GET);
		// Capturar todos los parámetros GET excepto 'id'
		$filteredParams = $_GET;
		unset($filteredParams['id']); // Eliminar 'id' de los parámetros

		$queryString = http_build_query($filteredParams); // Construir la cadena de consulta sin 'id'
		$this->_view->queryString = $queryString;
	...
	private function getDepartamento()
	{
		...
		$data = $modelData->getListDepartamentos();
